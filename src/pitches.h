...
// Roughly the notes on the piano starting with B0
// B0 is MIDI note 23, so when receiving "note 23"
// subtract by 23 to get the pitch
// ie: frequency = sNotePitches[note - 23]
