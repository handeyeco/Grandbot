 ...
 */
void SettingTransforms::noteLengthValueTransform(Setting &self, byte output[4]) {
  populateName(self, output);
 ...
 */
void SettingTransforms::sequenceLengthValueTransform(Setting &self, byte output[4]) {
  populateName(self, output);
 ...
 */
void SettingTransforms::collapseNotesValueTransform(Setting &self, byte output[4]) {
  populateName(self, output);
