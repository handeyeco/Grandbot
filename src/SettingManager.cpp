...
SettingManager::SettingManager(Expressions* _expr, ButtonManager* _buttons)
  ...
  midiChannelIn = new Setting(
      ...
      SettingTransforms::midiChStepTransform, SettingTransforms::noRandomize);
  ...
  fifthChance = new Setting(
      ...
      SettingTransforms::ccStepTransform, SettingTransforms::noRandomize);
  ...
  clock = new Setting(
      ...
      SettingTransforms::onOffStepTransform, SettingTransforms::noRandomize);
  ...
  bpm = new Setting(47, 113, CHAR_B, CHAR_BLANK,
                    ...
                    SettingTransforms::noRandomize, false);
  ...
  swing = new Setting(
      ...
      SettingTransforms::swingStepTransform, SettingTransforms::noRandomize);
