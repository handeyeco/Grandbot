...
SettingManager::SettingManager(Expressions* _expr, ButtonManager* _buttons)
  ...
  midiChannelIn = new Setting(
      0, 14, CHAR_I, CHAR_N, SettingTransforms::midiChValueTransform,
      SettingTransforms::midiChStepTransform, SettingTransforms::noRandomizeTransform);
  // MIDI channel to send to
  // options are: 0 = all channels / 1-16 = channels 1-16
  midiChannelOut = new Setting(
      0, 15, CHAR_O, CHAR_T, SettingTransforms::midiChValueTransform,
      SettingTransforms::midiChStepTransform, SettingTransforms::noRandomizeTransform);
  ...
  octaveOneUpChance = new Setting(
      10, 22, B01100011, B01000000, SettingTransforms::ccValueTransform,
      SettingTransforms::ccStepTransform, SettingTransforms::mediumRandomizeTransform);
  ...
  octaveTwoUpChance = new Setting(
      ...
      SettingTransforms::ccStepTransform, SettingTransforms::lowRandomizeTransform);
  ...
  restChance = new Setting(
      5, 29, CHAR_R, CHAR_E, SettingTransforms::ccValueTransform,
      SettingTransforms::ccStepTransform, SettingTransforms::mediumRandomizeTransform);
  ...
  fifthChance = new Setting(
      ...
      SettingTransforms::ccStepTransform, SettingTransforms::noRandomizeTransform);
  // Chance a step will be transposed randomly (-11 to 11)
  randomNoteChance = new Setting(
      0, 86, CHAR_R, CHAR_N, SettingTransforms::ccValueTransform,
      SettingTransforms::ccStepTransform, SettingTransforms::noRandomizeTransform);
  // Chance a step's length will be randomized
  randomLengthChance = new Setting(
      0, 87, CHAR_R, CHAR_L, SettingTransforms::ccValueTransform,
      SettingTransforms::ccStepTransform, SettingTransforms::noRandomizeTransform);
  ...
  slipChance = new Setting(
      ...
      SettingTransforms::ccStepTransform, SettingTransforms::highRandomizeTransform);

  // Whether to use an external (Et) or internal (In) clock
  clock = new Setting(
      0, 112, CHAR_C, CHAR_L, SettingTransforms::clockValueTransform,
      SettingTransforms::onOffStepTransform, SettingTransforms::noRandomizeTransform);
  ...
  sort = new Setting(
      0, 114, CHAR_S, CHAR_O, SettingTransforms::onOffValueTransform,
      SettingTransforms::onOffStepTransform, SettingTransforms::noRandomizeTransform);
  ...
  swing = new Setting(
      0, 115, CHAR_S, CHAR_G, SettingTransforms::swingValueTransform,
      SettingTransforms::swingStepTransform, SettingTransforms::noRandomizeTransform);
  ...
  useSpeaker = new Setting(
      0, 119, CHAR_S, CHAR_P, SettingTransforms::onOffValueTransform,
      SettingTransforms::onOffStepTransform, SettingTransforms::noRandomizeTransform);
